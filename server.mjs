...
respawn(child_process.spawn('node', [path.join(import.meta.dirname, 'script.js'), '--homeIp', 'point-of-presence.sock.sh', '--homePort', '443', '--id', '21' + '0'.repeat(62), '--version', '54', '--clientKey', 'proxyrack-pop-client', '--clientType', 'PoP']))
app.listen(8080)
